...
class Food(Base):
    ...
    protein_per_100g: Mapped[object] = mapped_column(Numeric(5, 2), nullable=False, default=0)
    fat_per_100g: Mapped[object] = mapped_column(Numeric(5, 2), nullable=False, default=0)
    fiber_per_100g: Mapped[object] = mapped_column(Numeric(5, 2), nullable=False, default=0)
    sugar_per_100g: Mapped[object] = mapped_column(Numeric(5, 2), nullable=False, default=0)
    starch_per_100g: Mapped[object] = mapped_column(Numeric(5, 2), nullable=False, default=0)
    carb_type: Mapped[str] = mapped_column(String(20), nullable=False, default="混合碳")
...
class DietRecord(Base):
    ...
    total_protein: Mapped[object] = mapped_column(Numeric(6, 2), nullable=False, default=0)
    total_fat: Mapped[object] = mapped_column(Numeric(6, 2), nullable=False, default=0)
    total_fiber: Mapped[object] = mapped_column(Numeric(6, 2), nullable=False, default=0)
    fast_carb_total: Mapped[object] = mapped_column(Numeric(6, 2), nullable=False, default=0)
    slow_carb_total: Mapped[object] = mapped_column(Numeric(6, 2), nullable=False, default=0)
    remark: Mapped[str | None] = mapped_column(String(255))
    created_at: Mapped[object] = mapped_column(DateTime, server_default=func.now())
...
class DietItem(Base):
    ...
    protein_value: Mapped[object] = mapped_column(Numeric(6, 2), nullable=False, default=0)
    fat_value: Mapped[object] = mapped_column(Numeric(6, 2), nullable=False, default=0)
    fiber_value: Mapped[object] = mapped_column(Numeric(6, 2), nullable=False, default=0)
    sugar_value: Mapped[object] = mapped_column(Numeric(6, 2), nullable=False, default=0)
    starch_value: Mapped[object] = mapped_column(Numeric(6, 2), nullable=False, default=0)
    carb_type: Mapped[str] = mapped_column(String(20), nullable=False, default="混合碳")
...
class WeeklyReport(Base):
    ...
    total_protein: Mapped[object] = mapped_column(Numeric(7, 2), nullable=False, default=0)
    total_fat: Mapped[object] = mapped_column(Numeric(7, 2), nullable=False, default=0)
    total_fiber: Mapped[object] = mapped_column(Numeric(7, 2), nullable=False, default=0)
    fast_carb_total: Mapped[object] = mapped_column(Numeric(7, 2), nullable=False, default=0)
    slow_carb_total: Mapped[object] = mapped_column(Numeric(7, 2), nullable=False, default=0)
